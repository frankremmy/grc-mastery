...
The case-study org profile lives in [`oscorp-profile.md`](oscorp-profile.md) —
sector, size, data held and applicable regulations. Every practical assessment
from module 2 onwards builds on it.
